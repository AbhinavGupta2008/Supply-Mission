...
var helicopterSprite, packageSprite,packageSpriteImg;
...
function setup() {
	...
	packageSprite.addImage("parcle",packageSpriteImg)
...
function draw() {
	...
	if(helicopterSprite.x>990)[
		helicopterSprite.lifetime=0
	]
	...
	fill("red");
	stroke("yellow")
	if(packageSprite.y>470 && packageSprite.x<490 && packageSprite.x>310){
		helicopterSprite.velocityX=3;
		text("YOU WON",350,350)
	}

	if( packageSprite.y>570){
		if( packageSprite.x>490 || packageSprite.x<310 ){
			helicopterSprite.velocityX=3;
